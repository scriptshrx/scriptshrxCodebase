...
export default function ResetPasswordContent() {
    ...
    const validateToken = async () => {
        try {
            const response = await fetch(`https://scriptishrxnewmark.onrender.com/api/auth/verify-reset-token/${token}`);
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await fetch('https://scriptishrxnewmark.onrender.com/api/auth/reset-password', {
                method: 'POST',
                headers: {
                ...
                <div className="bg-white/80 backdrop-blur-xl p-8 rounded-2xl shadow-2xl w-full border border-white/50">
                    ...
                    <div className="text-center mb-8">
                        <div className="flex justify-center mb-4">
                            <img src="/newLogo.jpg" alt="Scriptish" className="h-20 w-auto" />
                        </div>
